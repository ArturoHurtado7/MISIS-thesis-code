...
# models
module_models = [
    "mafcc-lcnn-attention-am", "mafcc-lcnn-attention-oc", "mafcc-lcnn-attention-p2s", "mafcc-lcnn-attention-sig",
    "mafcc-lcnn-fixed-am", "mafcc-lcnn-fixed-oc", "mafcc-lcnn-fixed-p2s", "mafcc-lcnn-fixed-sig",
    "mafcc-lcnn-lstmsum-am", "mafcc-lcnn-lstmsum-oc", "mafcc-lcnn-lstmsum-p2s", "mafcc-lcnn-lstmsum-sig"
]

...
# models
module_models = [
    "lcfcc-lcnn-attention-am", "lcfcc-lcnn-attention-oc", "lcfcc-lcnn-attention-p2s", "lcfcc-lcnn-attention-sig",
    "lcfcc-lcnn-fixed-am", "lcfcc-lcnn-fixed-oc", "lcfcc-lcnn-fixed-p2s", "lcfcc-lcnn-fixed-sig",
    "lcfcc-lcnn-lstmsum-am", "lcfcc-lcnn-lstmsum-oc", "lcfcc-lcnn-lstmsum-p2s", "lcfcc-lcnn-lstmsum-sig"
]

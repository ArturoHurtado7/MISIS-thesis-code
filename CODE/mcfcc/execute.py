...
# models
module_models = [
    "mcfcc-lcnn-attention-am", "mcfcc-lcnn-attention-oc", "mcfcc-lcnn-attention-p2s", "mcfcc-lcnn-attention-sig",
    "mcfcc-lcnn-fixed-am", "mcfcc-lcnn-fixed-oc", "mcfcc-lcnn-fixed-p2s", "mcfcc-lcnn-fixed-sig",
    "mcfcc-lcnn-lstmsum-am", "mcfcc-lcnn-lstmsum-oc", "mcfcc-lcnn-lstmsum-p2s", "mcfcc-lcnn-lstmsum-sig"
]

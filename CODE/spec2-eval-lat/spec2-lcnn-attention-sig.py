        ...
        for idx, (trunc_len, fft_n) in enumerate(zip(
            ...
            self.m_transform.append(
                torch_nn.Sequential(
                    ...
                    torch_nn.BatchNorm2d(32, affine=False), # rm
                    ...
                    torch_nn.BatchNorm2d(64, affine=False), # rm
                    ...
                    # rm
                    torch_nn.BatchNorm2d(16, affine=False),
                    torch_nn.Conv2d(16, 32, [1, 1], 1, padding=[0, 0]),
                    nii_nn.MaxFeatureMap2D(),
                    
                    torch_nn.BatchNorm2d(16, affine=False),
                    torch_nn.Conv2d(16, 32, [3, 3], 1, padding=[1, 1]),
                    nii_nn.MaxFeatureMap2D(),
                    # rm
